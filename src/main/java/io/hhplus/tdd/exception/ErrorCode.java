...
public enum ErrorCode {
    ...
    CHARGE_AMOUNT_TOO_LOW(HttpStatus.BAD_REQUEST, "최소 충전 금액은 1만 원 입니다."),
    USE_AMOUNT_TOO_LOW(HttpStatus.BAD_REQUEST, "최소 사용 금액은 5천 원 입니다."),
    NOT_UNIT_OF_THOUSAND(HttpStatus.BAD_REQUEST, "충전은 천원 단위로 가능합니다."),
